...
import { migrateLongIds } from "../lib/migration.js";
import { showWelcome, showHelp } from "../lib/displayUtils.js";
...
program
  .command("migrate")
  .description("Migrate long IDs to short IDs (one-time operation)")
  .action(() => {
    migrateLongIds();
  });
